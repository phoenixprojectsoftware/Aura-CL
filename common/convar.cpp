...
ConItemBase::ConItemBase(const char* name) : ConItemBase(name, "")
{
...
// ConVar
//---------------------------------------------------
ConVar::ConVar(const char* name, const char* def_val, int flags) : ConVar(name, def_val, flags, "")
{
...
#else
	gEngfuncs.Cvar_Set(GetName(), (char*)val);
#endif
}
...
#else
		gEngfuncs.Cvar_Set(m_pCvar->name, (char*)val);
#endif
	}
}
