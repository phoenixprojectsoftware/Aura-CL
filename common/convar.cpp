...
* AURA
*
* convar - console variable class. Uses code from BugfixedHL Rebased as per
* the license.
*
****/
...
#else
	gEngfuncs.Cvar_Set(GetName(), const_cast<char*>(val));
#endif
}
...
#else
		gEngfuncs.Cvar_Set(m_pCvar->name, const_cast<char*>(val));
#endif
	}
}
