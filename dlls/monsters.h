...
extern void UTIL_MoveToOrigin( edict_t* pent, const Legacy_Vector &vecGoal, float flDist, int iMoveType ); 

Legacy_Vector VecCheckToss ( entvars_t *pev, const Legacy_Vector &vecSpot1, Legacy_Vector vecSpot2, float flGravityAdj = 1.0 );
Legacy_Vector VecCheckThrow ( entvars_t *pev, const Legacy_Vector &vecSpot1, Legacy_Vector vecSpot2, float flSpeed, float flGravityAdj = 1.0 );
extern DLL_GLOBAL Legacy_Vector		g_vecAttackDir;
...
extern void EjectBrass (const Legacy_Vector &vecOrigin, const Legacy_Vector &vecVelocity, float rotation, int model, int soundtype );
extern void ExplodeModel( const Legacy_Vector &vecOrigin, float speed, int model, int count );

BOOL FBoxVisible ( entvars_t *pevLooker, entvars_t *pevTarget );
BOOL FBoxVisible ( entvars_t *pevLooker, entvars_t *pevTarget, Legacy_Vector &vecTargetOrigin, float flSize = 0.0 );
...
public:
	...
	static  void SpawnStickyGibs( entvars_t *pevVictim, Legacy_Vector vecOrigin, int cGibs );
