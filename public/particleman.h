...
public:
	...
	virtual void ApplyForce ( Legacy_Vector vOrigin, Legacy_Vector vDirection, float flRadius, float flStrength, float flDuration ) = 0;
	...
	virtual CBaseParticle *CreateParticle( Legacy_Vector org, Legacy_Vector normal, model_s * sprite, float size, float brightness, const char *classname  ) = 0;
	...
	virtual void CoreInitializeSprite ( CCoreTriangleEffect *pParticle, Legacy_Vector org, Legacy_Vector normal, model_s *sprite, float size, float brightness ) = 0; //Only use this for TrianglePlanes
	...
	virtual void CoreTouch ( CCoreTriangleEffect *pParticle, Legacy_Vector pos, Legacy_Vector normal, int index ) = 0;
...
public:
	...
	virtual void Touch(Legacy_Vector pos, Legacy_Vector normal, int index) { g_pParticleMan->CoreTouch( this, pos, normal, index ); }
	...
	virtual void InitializeSprite( Legacy_Vector org, Legacy_Vector normal, model_s *sprite, float size, float brightness )
	{
