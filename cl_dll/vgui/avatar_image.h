...
// Purpose:
//-----------------------------------------------------------------------------
class CAvatarImage : public vgui2::IImage
{
public:
	CAvatarImage(void);
	...
	void SetDefaultImage(vgui2::IImage* pImage) { m_pDefaultImage = pImage; }
...
// Purpose:
//-----------------------------------------------------------------------------
class CAvatarImagePanel : public vgui2::Panel
{
public:
	DECLARE_CLASS_SIMPLE(CAvatarImagePanel, vgui2::Panel);

	CAvatarImagePanel(vgui2::Panel* parent, const char* name);
	...
	void SetDefaultAvatar(vgui2::IImage* pDefaultAvatar);
